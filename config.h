...
#define PACKAGE_STRING "cgminer 3.9.0"
...
#define USE_BITMINE_A1 1

/* Defined to 1 if Drillbit BitFury support is wanted */
/* #undef USE_DRILLBIT */

/* Defined to 1 if GPIO Chip Select support is wanted in Bitmine A1 */
#define USE_GPIO_CS 1
...
/* Defined to 1 if ST MCU support is wanted in Bitmine A1 */
#define USE_ST_MCU 1
